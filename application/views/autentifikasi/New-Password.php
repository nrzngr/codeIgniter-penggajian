                    ...
                    <div class="row">
                        <div class="col-lg">
                            <div class="p-5">
                                ...
                                <form class="user" method="post" action="<?= base_url('autentifikasi/ubahPassword'); ?>">
                                    ...
                                    <div class="form-group">
                                        <input type="password" class="form-control form-control-user mt-3" id="password_baru2" name="password_baru2" placeholder="Ulangi Password Baru">
                                        <?= form_error('password_baru2', '<small class=:text-danger pl-3">', '</small>'); ?>
                                    </div>
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-primary btn-user btn-block mt-3">Ubah Password</button>
                                    </div>
                            </form>
                            </div>
                        </div>
